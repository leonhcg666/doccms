...
function edit_group()
{
	...
	{	
		...
		if(!is_file($toUrl.'pattern/'.$request['pattern'].'.css'))
		{
			copy(ABSPATH."inc/js/myfocus/myfocus-2.0.4.min.js",get_abs_skin_root()."res/plug-in/myfocus/myfocus-2.0.4.min.js");
			copy(ABSPATH."inc/js/myfocus/pattern/".$request['pattern'].'.css',get_abs_skin_root()."res/plug-in/myfocus/pattern/".$request['pattern'].".css");
			copy(ABSPATH."inc/js/myfocus/pattern/".$request['pattern'].'.js',get_abs_skin_root()."res/plug-in/myfocus/pattern/".$request['pattern'].".js");
			if(is_dir(ABSPATH."inc/js/myfocus/pattern/img/".$request['pattern']))
			{
				copy(ABSPATH."inc/js/myfocus/pattern/img/loading.gif",get_abs_skin_root()."res/plug-in/myfocus/pattern/img/loading.gif");
				dir_copy(ABSPATH."inc/js/myfocus/pattern/img/".$request['pattern'],get_abs_skin_root()."res/plug-in/myfocus/pattern/img/".$request['pattern']);
			}
		}
