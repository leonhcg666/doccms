    ...
    <form name="form1" method="post" action="./index.php?a=update&p=<?php echo $request['p'] ?>&i=<?php echo $request['i'] ?>" enctype="multipart/form-data" >
      <div class='box' >
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="4">
          <tr>
            <td width="60">页面标题</td>
            <td width="90%"><input type="text" name="title" id="title" class="txt" style="width:60%" value="<?php echo strFormat($article->title) ?>" />
              顺序
            ...
            <td colspan="2"><a href="javascript:showHide('field_pane_on_2')"><img src="images/expand.gif" border="0"> 填写关键词&摘要 </a>
              <div id="field_pane_on_2" style="display: none; padding:0; margin:0;">
                <table width="100%" border="0" align="center" cellpadding="0">
                  <tr>
                    <td> 页面关键词：</td>
                    <td width="90%"><textarea style='width:400px;' name='keywords' id='keywords' cols='90' rows='3'><?php echo strFormat($article->keywords) ?></textarea></td>
                  </tr>
                  <tr>
                    <td> 页面摘要：</td>
                    <td width="90%"><textarea style='width:400px;' name='description' id='description' cols='90' rows='3'><?php echo strFormat($article->description) ?></textarea></td>
                  </tr>
                </table>
              </div></td>
          </tr>
          ...
          <tr>
            <td colspan="2"><img src="./images/light.gif" alt="内容编辑小建议" border="0" /> 内容优化小建议：段落小标题请用h2,h3标签。文章主题关键词请使用strong,em标签加强语气！</td>
          </tr>
        </table>
      </div>
