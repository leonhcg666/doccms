    ...
    <tr>
      <td colspan="2" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;<span style="color:#FF0000">温馨提示</span>：如要对该篇文章分页，请在您要分页地方加上  <span style="color:#0000FF">{#page#}</span> 即可&nbsp;]
        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
          ...
          <tr>
            <td width="57">标题</td>
            <td width="90%"><input name="title" type="text" id="title" size="60" value="<?php echo strFormat($picture->title) ?>"></td>
          </tr>
          <tr>
            <td width="57">图片路径</td>
            <td><div class="picText">
                <div style="float:left;">
                  <input name="originalPic[0]" id="originalPic0" type="text"  value="<?php echo strFormat($originalPic[0])?>" size="60">
              ...
              <span id="picTips">[可直接贴入网络图片，例：http://www.iwangle.me/logo.jpg]</span></td>
          </tr>
          <tr>
            <td width="57"></td>
            <td><div id="newPic">
			...
			for($i=1;$i<20;$i++)
			{
                ...
                <div id="addpic<?php echo $i?>" <?php if($i>=count($originalPic)) echo 'style="display:none;" '; ?>class="picText">
                  <div style="float:left;">
                    <input name="originalPic[<?php echo $i?>]" id="originalPic<?php echo $i?>" type="text"  value="<?php echo strFormat($originalPic[$i])?>" size="60">
            ...
            <td colspan="2"><a href="javascript:showHide('field_pane_on_2')"><img src="images/expand.gif" border="0"> 填写关键词&摘要 </a>
              <div id="field_pane_on_2" style="display: none; padding:0; margin:0;">
                <table width="100%" border="0" align="center" cellpadding="0">
                  <tr>
                    <td> 页面关键词：</td>
                    <td width="90%"><textarea style='width:400px;' name='keywords' id='keywords' cols='90' rows='3'><?php echo strFormat($picture->keywords) ?></textarea></td>
                  </tr>
                  <tr>
                    <td> 页面摘要：</td>
                    <td width="90%"><textarea style='width:400px;' name='description' id='description' cols='90' rows='3'><?php echo strFormat($picture->description) ?></textarea></td>
                  </tr>
                </table>
              </div></td>
          </tr>
