...
<div id="editor-main">
	...
	<div id="editor-main-right">
		...
		<div id="helper">
			<span>标签在线帮助</span>
		    <ul>
		    	<li><a href="faq/index.html" target="_blank">index.php首页标签</a></li>
		        <li><a href="faq/common.html" target="_blank">common.php通用页标签</a></li>
		        <li><a href="faq/seolabel/index.html" target="_blank">模板标题、SEO标签</a></li>
                <li><a href="faq/navlabel/index.html" target="_blank">模板导航、子导航标签</a></li>
                <li><a href="faq/doclabel/index.html" target="_blank">模块应用、调用标签</a></li>
                <li><a href="faq/syslabel/index.html" target="_blank">系统应用、功能标签</a></li>
                <li><a href="faq/taglabel/index.html" target="_blank">系统路径、常量输出标签</a></li>
		    </ul>
		</div>
	</div>
</div>
