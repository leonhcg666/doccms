...
<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#C5EAF5">
  ...
  <tr>
	<td colspan=2 valign="top" class="tablerow">&nbsp;<span style="color:red">注意:</span>上传文件格式须为SQL格式，且命名格式为：数据库名称+下划线_+8位备份日期+下划线_+6位随机数+数据表备份卷号，如wangle_20120701_247512_1.sql。</td>
  </tr>
</table>
</form>