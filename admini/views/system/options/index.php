          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td>站点标题：</td>
                    <td colspan="2"><input name="sitename" type="text" class="txt" id="sitename" value="<?php echo htmlspecialchars(stripslashes(SITENAME)) ?>" size="41" /></td>
                  </tr>
                  <tr>
                    <td>站点关键词：</td>
                    <td colspan="2"><textarea name="sitekeywords" id="sitekeywords" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITEKEYWORDS)) ?></textarea></td>
                  </tr>
                  <tr>
                    <td>站点摘要：</td>
                    <td colspan="2"><textarea name="sitesummary" id="sitesummary" class="txt" cols="27" rows="3"><?php echo htmlspecialchars(stripslashes(SITESUMMARY)) ?></textarea></td>
                  </tr>
                  <tr>
                    <td>站点资源文件上传路径：</td>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input name="urlrewrite" <?php if (URLREWRITE)echo 'checked="checked"';?> type="checkbox" id="urlrewrite" />
                      用来对搜索引擎优化<span class="small">（*此功能需要把程序放在站点根目录并且需要服务器环境支持URL重写功能,否则此功能将无法使用）</span></td>
                  ...
                  <tr>
                    <td>报刊宽度：</td>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<input name="paperPicWidth" type="text" class="txt" id="paperPicWidth" value="<?php echo paperPicWidth?>" style="width:100px;"/>
                      <span class="small">px</span>
                  </tr>
                  <tr>
                    <td>报刊高度：</td>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<input name="paperPicHight" type="text" class="txt" id="paperPicHight" value="<?php echo paperPicHight ?>" style="width:100px;"/>
                      <span class="small">px</span>
                  </tr>
