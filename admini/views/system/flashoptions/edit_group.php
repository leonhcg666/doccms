                    ...
                    <div id="myFocus" class="<?php echo $edit_group_item->pattern?>"><!--焦点图盒子-->
                      ...
                      <div class="__pic">
                        <ul>
                          ...
                          ?>
                          <li><a target="_blank" href="http://www.iwangle.me/"><img src="images/ad_focus/banner1.jpg" thumb="" alt="焦点图模块演示图片之一" text="图片1更详细的描述文字" /></a></li>
                                  <li><a target="_blank" href="http://www.iwangle.me/"><img src="images/ad_focus/banner2.jpg" thumb="" alt="焦点图模块演示图片之二" text="图片2更详细的描述文字" /></a></li>
                                  <li><a target="_blank" href="http://www.iwangle.me/"><img src="images/ad_focus/banner3.jpg" thumb="" alt="焦点图模块演示图片之三" text="图片3更详细的描述文字" /></a></li>
                                  <li><a target="_blank" href="http://www.iwangle.me/"><img src="images/ad_focus/banner4.jpg" thumb="" alt="焦点图模块演示图片之三" text="图片3更详细的描述文字" /></a></li>
                          <?php
                            }
                            ?>
                        </ul>
