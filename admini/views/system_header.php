...
<script language="JavaScript" type="text/javascript" src="../inc/js/jquery-1.11.3.min.js"></script>
...
<?php if($_SESSION[TB_PREFIX.'admin_roleId']>8){ ?>
  <ul>
    ...
    <li><h3><a href='./index.php?m=system&s=migration' title='网站的数据库备份及恢复' id='m10'>备份及恢复</a></h3><div class="sjhq"><h4><b></b></h4></div></li>
  </ul>
<?php }
