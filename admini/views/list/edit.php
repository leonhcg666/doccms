...
.tcolor{width:22px;height:20px;display:block; float:left; margin:0 10px;}
      ...
      <table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
        ...
        <tr>
          <td width="77">页面标题</td>
          <td width="841"><input type="text" class="txt" name="title" id="title" style="width:96%" value="<?php echo strFormat($list_item->title) ?>"></td>
        </tr>
        <tr>
          <td width="77">作者</td>
          <td width="90%"><input type="text" class="txt"  name="author" id="title" style="width:96%" value="<?php echo strFormat($list_item->author) ?>"></td>
        </tr>
        <tr>
          <td width="77">来源名称</td>
          <td><input type="text" class="txt"  name="source" id="source" style="width:96%" value="<?php echo strFormat($list_item->source) ?>"></td>
        </tr>
		<tr>
          <td width="77">来源链接</td>
          <td><input type="text" class="txt"  name="sourceUrl" id="sourceUrl" style="width:96%" value="<?php echo strFormat($list_item->sourceUrl) ?>"></td>
        </tr>
        <tr>
          <td colspan="2"><a href="javascript:showHide('field_pane_on_2')"><img src="images/expand.gif" border="0"> 填写关键词&摘要 </a>
            <div id="field_pane_on_2" style="display: none; padding:0; margin:0;">
              <table width="100%" border="0" align="center" cellpadding="0">
                <tr>
                  <td> 页面关键词：</td>
                  <td width="90%"><textarea style='width:400px;' name='keywords' id='keywords' cols='90' rows='3'><?php echo strFormat($list_item->keywords) ?></textarea></td>
                </tr>
                <tr>
                  <td> 页面摘要：</td>
                  <td><textarea style='width:400px;' name='description' id='description' cols='90' rows='3'><?php echo strFormat($list_item->description) ?></textarea></td>
                </tr>
              </table>
          </div></td>
        </tr>
    ...
    <td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="4">
        <tr>
          <td width="861"><div id="field_pane_on_3" style="display: none; padding:0; margin:0;"> 上传缩略图：
              ...
              选择对应焦点图名称(为空则不选择):<select name="group_id"><option value="0">　</option><?php
              if(!empty($result)){
                foreach ($result as $value) {?><option value="<?php echo $value['id'] ?>"><?php echo $value['title'] ?></option><?php }}?></select>
