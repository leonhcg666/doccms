...
class dtdb {
	...
	public function __construct($dbuser, $dbpassword, $dbname, $dbhost) {
		...
		<p>如果你不确定这些信息请联系你的虚拟主机服务供应商. 如果仍然不能解决请联系 <a href='http://www.iwangle.me/'>wangle</a>.</p>
		");
		}
	...
	//	Select a DB (if another one needs to be selected)
		...
		<ul>
			<li>你确定这个数据库存在?</li>
			<li>一些系统中会将你的用户名作为你数据库的前缀,就像这样 username_cms. 检查一下你是否是这个问题?</li>
		</ul>
		<p>如果你不知道怎样在MYSQL中 设置/安装 一个数据库，那么请<strong>联系你的虚拟主机供应商</strong>. 如果都不是以上的问题请联系 <a href='http://www.iwangle.me/'>wangle</a>.</p>");
			}
		}
...
<head>
	...
	<body>
	<h1 id="logo"><a href='http://www.iwangle.me/'>wangle</a></h1>
HEAD;
...
class DtDatabase extends dtdb {
	public function __construct() {
		parent::__construct(DB_USER, DB_PASSWORD, DB_DBNAME, DB_HOSTNAME);
