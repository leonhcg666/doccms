...
--<br>--
DROP TABLE IF EXISTS `##_paper_group`;
--<br>--
CREATE TABLE `##_paper_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `channelId` int(11) NOT NULL DEFAULT '0' COMMENT '频道栏目ID',
  `title` varchar(200) NOT NULL DEFAULT '' COMMENT '分组标题',
  `summary` text COMMENT '摘要',
  `pdfpath` varchar(255) NOT NULL DEFAULT '' COMMENT 'pdfpath',
  `puby` varchar(200) NOT NULL DEFAULT '' COMMENT '出版局',
  `type` varchar(200) NOT NULL DEFAULT '' COMMENT '周刊月刊',
  `picpath` varchar(255) NOT NULL DEFAULT '' COMMENT '封面图',
  `ordering` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `txtHeight` varchar(50) NOT NULL DEFAULT 'default' COMMENT '文字高度',
  `pubTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '发刊时间',
  `dtTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8

--<br>--
DROP TABLE IF EXISTS `##_paper`;
--<br>--
CREATE TABLE `##_paper` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `description` varchar(255) NOT NULL DEFAULT '' COMMENT '摘要',
  `url` text NOT NULL COMMENT '锚点',
  `picpath` varchar(200) NOT NULL DEFAULT '' COMMENT '图片路径',
  `pdfpath` varchar(200) NOT NULL DEFAULT '' COMMENT 'PDF路径',
  `group_id` int(11) NOT NULL DEFAULT '0' COMMENT '报纸分组id',
  `ordering` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `dtTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8
...
--<br>--
DROP TABLE IF EXISTS `##_paperlist`;
--<br>--
CREATE TABLE `##_paperlist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `channelId` int(11) NOT NULL DEFAULT '0' COMMENT 'channelId',
  `paperID` int(11) NOT NULL DEFAULT '0' COMMENT 'paperID',
  `pwidth` int(11) NOT NULL,
  `pheight` int(11) NOT NULL,
  `ptop` int(11) NOT NULL,
