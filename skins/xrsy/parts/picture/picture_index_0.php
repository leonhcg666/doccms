...
#piclist ul li{ list-style:none; float:left; background:url(<?php echo $tag['path.skin']; ?>res/images/probox_bg3.gif) 10px 6px no-repeat; width:225px;height: 200px; padding:20px 0 0 25px;}
