...
define('DB_USER','root');
define('DB_PASSWORD','');
define('DB_DBNAME','gtdstudio');
define('TB_PREFIX','gtd_');
//模板配置字段
define('WEBOPEN',true);
define('WEBSIZE','500');
define('WEBSIZECOUNTS','24');
define('WEBURL','www.wangle.com');
define('SITENAME','wangle网站管理系统 v3.0');
define('SITEKEYWORDS','');
define('SITESUMMARY','');
define('HTMLPATH','/html');
define('UPLOADPATH','/upload/');
define('TIMEZONENAME','8');
define('STYLENAME','xrsy');
...
//系统开始运行时间
define('cmsbirthday','now');//此处如无需要请不要随意更改，否则将无法正常运行
//编辑器
...
//水印图片
define('ISWATER',true);
define('WATERIMGS','/inc/img/system/wangle.png');
//缩略图背景颜色设置
...
/*上传图片的大小设置*/
define('paperPicWidth','394');
define('paperPicHight','584');
